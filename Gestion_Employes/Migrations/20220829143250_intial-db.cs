        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nom_equipe = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_employe_categorie_CategorieId",
                        column: x => x.CategorieId,
                        principalTable: "categorie",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_employe_equipe_EquipeId",
                        column: x => x.EquipeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_projet_equipe_IdEquipe",
                        column: x => x.IdEquipe,
                        principalTable: "equipe",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_historique_employe_employeId",
                        column: x => x.employeId,
                        principalTable: "employe",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_historique_equipe_equipeId",
                        column: x => x.equipeId,
                        principalTable: "equipe",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_historique_projet_projetId",
                        column: x => x.projetId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_employe_CategorieId",
                table: "employe",
                column: "CategorieId");

            migrationBuilder.CreateIndex(
                name: "IX_employe_EquipeId",
                table: "employe",
                column: "EquipeId");

            migrationBuilder.CreateIndex(
                name: "IX_historique_employeId",
                table: "historique",
                column: "employeId");

            migrationBuilder.CreateIndex(
                name: "IX_historique_equipeId",
                table: "historique",
                column: "equipeId");

            migrationBuilder.CreateIndex(
                name: "IX_historique_projetId",
                table: "historique",
                column: "projetId");

            migrationBuilder.CreateIndex(
                name: "IX_projet_IdEquipe",
                table: "projet",
                column: "IdEquipe",
                unique: true);
        }
